...
import com.bishe.portal.service.enums.ThumbModelEnum;
...
public class QiniuImg {
    ...
    public String getUrl16() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url16==null){
            this.url16 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_16.getValue());
        }
        return this.url16;
    }
    ...
    public String getUrl32() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url32==null){
            this.url32 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_32.getValue());
        }
        return this.url32;
    }
    ...
    public String getUrl48() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url48==null){
            this.url48 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_48.getValue());
        }
        return this.url48;
    }
    ...
    public String getUrl64() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url64==null){
            this.url64 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_64.getValue());
        }
        return this.url64;
    }
    ...
    public String getUrl128() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url128==null){
            this.url128 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_128.getValue());
        }
        return this.url128;
    }
    ...
    public String getUrl256() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url256==null){
            this.url256 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_256.getValue());
        }
        return this.url256;
    }
    ...
    public String getUrl512() {
        if(StringUtils.isEmpty(key)) return  null;
        if(this.url512==null){
            this.url512 = QiniuWrapper.getUrl(key, ThumbModelEnum.THUMB_512.getValue());
        }
        return this.url512;
    }
